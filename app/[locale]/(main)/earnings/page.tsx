...
export default async function EarningsPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <p className="text-gray-500 text-xs mb-6">1 AMB = 1 USDT</p>
        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="rounded border border-green-700/30 bg-green-900/10 p-5 flex flex-col gap-1">
              ...
              <p className="text-3xl font-bold text-green-400">
                ...
                <span className="text-base text-green-600 ml-1.5">AMB</span>
              </p>
            ...
            <div className="rounded border border-yellow-700/30 bg-yellow-900/10 p-5 flex flex-col gap-1">
              ...
              <p className="text-3xl font-bold text-yellow-400">
                ...
                <span className="text-base text-yellow-600 ml-1.5">AMB</span>
              </p>
          ...
          <div className="rounded border border-border bg-surface">
            <div className="px-4 py-3 border-b border-border">
              ...
              <p className="text-gray-500 text-xs">Withdraw address — AMB from your sales will be sent here.</p>
            </div>
                  ...
                  <div key={tx.id} className="flex items-center justify-between px-4 py-3">
                    <div className="flex items-center gap-2 min-w-0">
                      ...
                      <div className="min-w-0">
                        <p className="text-accent-gold text-sm">{Number(tx.amount).toFixed(2)} AMB</p>
              ...
              <div className="divide-y divide-border">
                {typedPayouts.map((p) => {
                  ...
                  <div key={p.id} className="flex items-center justify-between px-4 py-3">
                    <div className="min-w-0">
                      <p className="text-accent-gold text-sm font-medium">{Number(p.amount).toFixed(2)} AMB</p>
