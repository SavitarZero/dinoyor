...
export default async function MyListingsPage({
  ...
  let query = supabase
    .from('listings')
    .select('id, title, price_amount, price_currency, images, status, sold_count, created_at, games(name, slug, logo_url)')
    ...
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-6">
      ...
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-0.5">Items you're selling</p>
        </div>
        <Link
          href="/listings/new"
            ...
            >
              ...
              <div className="relative aspect-video bg-background overflow-hidden">
                ...
                <div className="absolute top-2 left-2">
                  <span className={`text-[10px] font-bold px-1.5 py-0.5 rounded-full ${STATUS_CLASS[listing.status] ?? 'bg-gray-700 text-gray-400'}`}>
              ...
              <div className="p-3 flex flex-col gap-2 flex-1">
                <p className="text-white text-xs font-medium leading-snug line-clamp-2 min-h-8">
                  {listing.title}
                </p>
                {listing.games && (
