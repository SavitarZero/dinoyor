  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-2 mb-6">
      <input
        ...
        className="flex-1 px-4 py-2.5 rounded bg-surface border border-border text-white placeholder-gray-600 text-sm focus:outline-none focus:border-accent transition-colors"
      />
      <div className="flex gap-2">
        ...
        <button
          type="submit"
          className="px-5 py-2.5 rounded bg-accent text-black text-sm font-bold hover:opacity-90 transition-opacity"
        >
          Search
        </button>
      </div>
