      ...
      <div className="flex-1 w-full sm:w-auto">
        ...
        <div className="relative">
          <input
            ...
            className="w-full px-3 py-2.5 pr-9 rounded-xl bg-background border border-border text-white text-sm focus:outline-none focus:border-focus-border transition-colors"
          />
